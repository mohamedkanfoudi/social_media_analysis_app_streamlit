...
page = st.sidebar.selectbox("Prepare data to analyse and to predict future values",
 ("Connect to Snowflake" ,"Analyse","Predict future values","Sentiment analysis for comments"))
